...
PUBLIC_METHOD_PATHS = {
    ...
    ("/execute/pdf", "POST"),
    ("/commercial/shadow/activate", "POST"),
    ("/commercial/shadow/deactivate", "POST"),
    ("/commercial/shadow/run", "POST"),
    ("/commercial/shadow/status", "GET"),
    ("/commercial/mission-control", "GET"),
    ("/demo", "GET"),
    ("/demo/diagnostico", "GET"),
    ("/demo/guardian", "GET"),
    ("/system/mode", "GET"),
    ("/smtp/status", "GET"),
    ("/smtp/send", "POST"),
