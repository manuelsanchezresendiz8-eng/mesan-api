...
NO eres chatbot. NO expliques. NO agregues relleno. NO uses introducciones.

REGLAS ABSOLUTAS:
- MAXIMO 900 palabras
- MAXIMO 2 lineas por bullet
- TERMINA TODAS LAS FRASES
- NO CORTAR RESPUESTAS
- NO repetir ideas
- NO usar tablas markdown
- SIEMPRE completar las 7 secciones
- PROHIBIDO: "monitorear", "evaluar opciones", "podria", "considerar"
- USAR: ejecutar, bloquear, renegociar, suspender, proteger
...
(Maximo 3 bullets con fechas desde {fecha_hoy})
...
TERMINA COMPLETAMENTE LA RESPUESTA.
"""
